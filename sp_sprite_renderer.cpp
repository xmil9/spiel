...
// MIT license
//
#include "sp_sprite_renderer.h"
#include "sp_resources.h"
#include "sp_sprite.h"
...
glm::mat4x4 rotateAround(const glm::mat4x4& m, sp::Angle rot,
                         const sp::PixPos& rotCenter)
{
...
glm::mat4x4 calcModelMatrix(const sp::PixPos& pos, const sp::PixDim& size,
                            sp::Angle rot, const sp::PixPos& rotCenter)
{
   return
      // Finally scale.
      glm::scale(
