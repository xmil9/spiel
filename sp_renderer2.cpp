...
{
   gll::Shader vs{gll::makeVertexShader(shaderPath / "sp_sprite_shader.vs")};
   gll::Shader fs{gll::makeFragmentShader(shaderPath / "sp_sprite_shader.fs")};
   if (!vs || !fs)
      return false;
